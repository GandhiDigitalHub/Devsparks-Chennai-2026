...
![Download the IBM Bob IDE](images-install/img60.png)
...
![Enter registration details](images-install/img51.png)

4. Enter the verification code sent to your email.
5. Click **Submit**.

![Verify and submit registration details](images-install/img52.png)

6. Click **Proceed**.

![Proceed with trial registration](images-install/img53.png)

![Complete trial registration](images-install/img54.png)

Your IBM Bob trial licence is now ready to use.

![IBM Bob trial licence confirmation](images-install/img55.png)
...
![Log in to IBM Bob](images-install/img60.png)

3. Click **Open** to launch the login page in your web browser.

![Open the login page](images-install/img61.png)

4. Enter your login information and click **Continue**.

![Enter login information](images-install/img62.png)

5. Click **Open** to return to the IBM Bob IDE.

![Return to the IBM Bob IDE](images-install/img63.png)

You are now signed in to the IBM Bob IDE and can begin using it.

![IBM Bob IDE login completed](images-install/img64.png)
